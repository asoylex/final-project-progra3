...
const WordForm = () => {
  ...
  const translateText = async (text: any, targetLanguage: any) => {
    ...
    try {
      ...
      setHistorySearch(prevHistory => [...prevHistory, translate]);
      ...
      <div className='overflow-hidden rounded-lg bg-white shadow m-10 lg:text-center lg:w-1/2'>
        <div className='justify-center mt-20 font-mono px-4 py-5 sm:p-6'>
          ...
          <div className='flex justify-around mb-4'>
            ...
            <button className='rounded-md bg-black px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-black/70' onClick={()=> handleDeleteFirstNode()}>Eliminar Primer Nodo</button>
        ...
        <div>
          <h1 className='text-black'>HISTORIAL</h1>
          {historySearch.length > 0 ? (
            historySearch.map((word: any, index: any) => (
              <div key={index} className='flex justify-between p-3 border-b border-gray-200'>
